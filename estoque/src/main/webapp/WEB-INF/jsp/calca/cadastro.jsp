...
<body>
	...
	<div class="container">
		...
		<form action="/calca/incluir" method="post">
			<h2>Cadastramento de Calcas</h2>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="descricao" value="Calca preta com elastico e brasao"> 
			</div>
			...
			<div class="form-group">
				...
				<div class="checkbox">
				  <label><input type="checkbox" name="comcinto" value="false" checked> Com Cinto?</label>
				</div>				
			</div>
